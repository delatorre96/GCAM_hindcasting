...
module_aglu_ag_an_demand_input_xml <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    real_inputs <- module_aglu_ag_an_demand_input_xml(driver.DECLARE_INPUTS)
    inputs_2 <- new_chunks_2010$zaglu_xml_ag_an_demand_input.R
    ...
    for (df_i in intersect(real_inputs, names(inputs_2))) {
      df_ <- new_chunks_2010$'zaglu_xml_ag_an_demand_input.R'[[df_i]]
