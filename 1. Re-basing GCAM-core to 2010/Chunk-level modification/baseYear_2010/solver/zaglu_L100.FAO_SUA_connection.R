...
module_aglu_L100.FAO_SUA_connection <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    aglu.AGLU_HISTORICAL_YEARS <- 1973:2021
    aglu.MODEL_MACRONUTRIENT_YEARS <- 2020:2022
    # check years
    # to remove
    ...
    # Produce outputs ----
    #********************************* ----
    L100.FAO_SUA_APE_balance %>% filter(year <= 2010) %>%
    ...
    L100.FAO_ag_HA_ha %>% filter(year <= 2010) %>%
    ...
    L100.FAO_ag_Prod_t %>% filter(year <= 2010) %>%
    ...
    L100.FAO_PRODSTAT_TO_DOWNSCAL %>% filter(year <= 2010) %>%
    ...
    L101.an_Prod_Mt_R_C_Y %>% filter(year <= 2010) %>%
    ...
    L101.an_Prod_Mt_ctry_C_Y %>% filter(year <= 2010) %>%
    ...
    L101.ag_Food_Mt_R_C_Y %>% filter(year <= 2010) %>%
    ...
    L101.CropMeat_Food_Pcal_R_C_Y %>% filter(year <= 2010) %>%
    ...
    L101.an_Food_Mt_R_C_Y %>% filter(year <= 2010) %>%
    ...
    L101.ag_Feed_Mt_R_C_Y %>% filter(year <= 2010) %>%
    ...
    L101.GrossTrade_Mt_R_C_Y %>% filter(year <= 2010) %>%
    ...
    L101.ag_Storage_Mt_R_C_Y %>% filter(year <= 2010) %>%
